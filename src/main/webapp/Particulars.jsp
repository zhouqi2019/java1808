                    ...
                    <div class="widget-main">
                        ...
                        <table class="table table-bordered table-striped">
                            <tbody><tr>
                                ...
                                <td>
                                    <input type="text" id="good_name" name="good_name" value="${wxbGood.goodName}">
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="type_id" id="type_id" style="width:252px;font-size:14px" class="selectBox">
                                        <option value="${wxbGood.typeId}">请选择...</option>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="order_no" name="order_no" onkeyup="checkVal2(this);" value="${wxbGood.orderNo}">
                                </td>
                            </tr>
                            <tr>
                                <td align="right"><span class="red">*</span><strong>购买作弊值：</strong></td>
                                <td>
                                    <input type="text" id="sell_num" name="sell_num" onkeyup="checkVal2(this);" value="${wxbGood.sellNum}">
                                </td>
                            </tr>
                            <tr>
